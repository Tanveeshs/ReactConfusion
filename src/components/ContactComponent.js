...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email){
        ...
        {
            errors.firstname = 'First Name should be lesser than 12 characters';
        }
        ...
        {
            errors.lastname = 'Last Name should be lesser than 12 characters';
        }
        const reg = /^\d+$/;
        if(this.state.touched.telnum && !reg.test(telnum))
        {
            errors.telnum = 'Telephone number should be number';
        }
